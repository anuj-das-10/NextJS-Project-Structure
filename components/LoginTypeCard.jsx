...
const LoginTypeCard = ({route_URL, name, logo_url, alt_text, description}) => {
  return (
    <div>
         <Link href={route_URL}>
          <div className='bg-gray-950 w-[280px] h-[350px] sm:w-[500px] sm:h-[280px] md:w-[700px] lg:w-[400px] lg:h-[300px] rounded-md p-2 my-6 transition-all duration-200 hover:-translate-y-2  hover:border-purple-600 hover:border-2'>
